namespace FishingVillage.Dialogue
{
    public class DialogueSequence
    {
        ...
        public bool EnableProximityDialogueAfter { get; private set; }
        ...
        public DialogueSequence(SODialogueSequence sequence, bool enableProximityDialogueAfter)
        {
            _dialogueSequence = sequence;
            _currentIndex = 0;
            EnableProximityDialogueAfter = enableProximityDialogueAfter;
        }
